...
with tab1:
    ...
    with col3:
      st.markdown("""
                  ...
                  3. Multiplies $t = As + e$ and constructs her public encapsulation key as the concatenation of $t$ and a seed that can be used to reconstruct $A$. She this over to Bob.
