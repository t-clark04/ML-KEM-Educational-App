...
def generate_keygen_graph():
    ...
    net.add_node("A_hat", label="Â", title="A $k \times k$ matrix containing elements from the NTT domain \n (NTT representations of polynomials). Sometimes called the public \n key matrix.", shape="ellipse", color="seagreen", x=-167, y=-513, font={'color': 'white'})
    net.add_node("t_hat", label="t\u0302 = Â · ŝ + ê", title="A $k \times 1$ matrix containing elements from the NTT domain \n (NTT representations of polynomials). The other part of \n the public key.", shape="ellipse", color="seagreen", x=-43, y=-513, font={'color': 'white'})
...
def generate_encaps_graph():
  ...
  net.add_node("v", label="v = tᵀy + e₂ + μ", title="Result is a 1 x 1 polynomial with coefficients in \n the ring of polynomials.", shape="ellipse", color="seagreen", x=-100, y=-658, font={'color': 'white'})
